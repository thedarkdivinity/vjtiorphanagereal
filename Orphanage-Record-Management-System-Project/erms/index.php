      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4" style="margin-top: 2%">
            <h1 class="h3 mb-0 text-gray-800">  Orphange Record Management System</h1>
          </div>
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">  <a href="loginerms.php">
                      <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Warden Signin</div>
                      </a>
                    </div>
                    <div class="col-auto">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Warden Signup</div>
                 </a>
                    </div>
                    <div class="col-auto">
                      <i class="fas fa-user fa-2x text-gray-300"></i>
          ...
          <div class="row">
            ...
            <div class="col-xl-4 col-md-6 mb-4">
              <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">  <a href="canteen/canteenlogin.php">
                      <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Canteen Signin</div>
                      </a>
                    </div>
                    <div class="col-auto">
                      <i class="fas fa-user fa-2x text-gray-300"></i>
            ...
            <div class="col-xl-4 col-md-6 mb-4">
              <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <a href="canteen/canteenregis.php">
                      <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Canteen Signup</div>
                 </a>
                    </div>
                    <div class="col-auto">
                      <i class="fas fa-user fa-2x text-gray-300"></i>
