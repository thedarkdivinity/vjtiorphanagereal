...
if(isset($_POST['submit']))
  {
    ...
    $emp3wd=$_POST['emp3workduration'];
     ...
     $query=mysqli_query($con, "insert into canteenexp ( EmpID,Employer1Name, Employer1Designation, Employer1CTC,  Employer1WorkDuration, Employer2Name,  Employer2Designation, Employer2CTC, Employer2WorkDuration, Employer3Name, Employer3Designation, Employer3CTC, Employer3WorkDuration) value('$eid','$emp1name', '$emp1des', '$emp1ctc', '$emp1wd', '$emp2name', '$emp2des', '$emp2ctc', '$emp2wd', '$emp3name', '$emp3des', '$emp3ctc', '$emp3wd' )");
    if ($query) {
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <!-- Sidebar -->
  <?php include_once('../includes/canteensidebar.php')?>
    <!-- End of Sidebar -->
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <!-- Topbar -->
         <?php include_once('../includes/canteenheader.php')?>
        <!-- End of Topbar -->
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Servings</h1>
...
<p style="font-size:16px; color:red" align="center"> <?php if($msg){
  ...
  <?php 
$empid=$_SESSION['uid'];
$query=mysqli_query($con,"select * from canteenexp where EmpID=$empid");
$row=mysqli_fetch_array($query);
if($row>0)
{

?>
<p style="font-size:16px; color:red" align="center">Your Orphan details already added. Now you can only edit the record. </p>
<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">

<tr>
  <th>First Orphan Name</th>
  <td><?php echo $row['Employer1Name'];?></td>
</tr>
<tr>
  <th>First Orphan Food Preferences </th>
  <td><?php echo $row['Employer1Designation'];?></td>
</tr>
<tr>
  <th>First Orphan Age</th>
  <td><?php echo $row['Employer1CTC'];?></td>
</tr>
<tr>
  <th>First Orphan Food Intake</th>
  <td><?php echo $row['Employer1WorkDuration'];?></td>
</tr>
<tr>
  <th>Second Orphan Name</th>
  <td><?php echo $row['Employer2Name'];?></td>
</tr>
<tr>
  <th>Second Orphan Food Preferences</th>
  <td><?php echo $row['Employer2Designation'];?></td>
</tr>
<tr>
  <th>Second Orphan Age</th>
  <td><?php echo $row['Employer2CTC'];?></td>
</tr>
<tr>
  <th>Second Orphan Food Intake</th>
  <td><?php echo $row['Employer2WorkDuration'];?></td>
</tr>
<tr>
  <th>Third Orphan Name</th>
  <td><?php echo $row['Employer3Name'];?></td>
</tr>
<tr>
  <th>Third Orphan Food Preferences</th>
  <td><?php echo $row['Employer3Designation'];?></td>
</tr>
<tr>
  <th>Third Orphan Age</th>
  <td><?php echo $row['Employer3CTC'];?></td>
</tr>
<tr>
  <th>Third Orphan Food Intake</th>
...
<form class="user" method="post" action="">
               ...
               <div class="row">
                <div class="col-4 mb-3">Orphan1 Name</div>
                   <div class="col-8 mb-3">   <input type="text" class="form-control form-control-user" id="emp1name" name="emp1name" aria-describedby="emailHelp" value=""></div>
                    ...
                    <div class="row">
                      <div class="col-4 mb-3">Orphan1 Food Preferences </div>
                    ...
                    <div class="row">
                <div class="col-4 mb-3">Orphan2 Name</div>
                   <div class="col-8 mb-3">   <input type="text" class="form-control form-control-user" id="emp2name" name="emp2name" aria-describedby="emailHelp" value=""></div>
                    ...
                    <div class="row">
                      <div class="col-4 mb-3">Orphan2 Food Preferences </div>
                    ...
                    <div class="row">
                <div class="col-4 mb-3">Orphan3 Name</div>
                   <div class="col-8 mb-3">   <input type="text" class="form-control form-control-user" id="emp3name" name="emp3name" aria-describedby="emailHelp" value=""></div>
                    ...
                    <div class="row">
                      <div class="col-4 mb-3">Orphan3 Food Preferences </div>
