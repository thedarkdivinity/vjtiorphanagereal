...
if(isset($_POST['login']))
  {
    ...
    $query=mysqli_query($con,"select ID from canteen where  EmpEmail='$Email' && EmpPassword='$Password' ");
    $ret=mysqli_fetch_array($query);
    if($ret>0){
      $_SESSION['uid']=$ret['ID'];
     header('location:welcomecanteen.php');
    }
    else{
      $msg="Invalid Details.";
    }
...
<body class="bg-gradient-primary">
  ...
  <div class="container">
    ...
    echo $msg;
                  ...
                  <hr>
                  <div class="text-center">
                    <a class="small" href="canteenforgetpassword.php">Forgot Password?</a>
                  </div>
                  <div class="text-center">
                    <a class="small" href="canteenregis.php">Create an Account!</a>
                  </div>
                </div>
              </div>
            </div>
