...
if(isset($_POST['submit']))
  {
    ...
    $ret=mysqli_query($con, "select EmpEmail from canteen where EmpEmail='$Email'");
    $result=mysqli_fetch_array($ret);
    if($result>0){
$msg="This email already associated with another account";
    }
    else{
    $query=mysqli_query($con, "insert into canteen(EmpFname, EmpLName, EmpCode, EmpEmail,  EmpPassword) value('$FName', '$LName', '$empcode', '$Email', '$Password' )");
    if ($query) {
...
<body class="bg-gradient-primary">
  ...
  <div class="container">
    ...
    echo $msg;
              ...
              <div class="text-center">
                <a class="small" href="canteenlogin.php">Already have an account? Login!</a>
              </div>
            </div>
          </div>
        </div>
