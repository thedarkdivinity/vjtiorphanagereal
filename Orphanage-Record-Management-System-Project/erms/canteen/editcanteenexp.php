...
if (strlen($_SESSION['uid']==0)) {
  header('location:canteenlogout.php');
  } else{
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Edit My Orphans</h1>
...
<form class="user" method="post" action="">
  <?php
 $empid=$_SESSION['uid'];
$ret=mysqli_query($con,"select * from canteenexp where EmpID='$empid'");
               ...
               <div class="row">
                <div class="col-4 mb-3">Orphan1 Name</div>
                   <div class="col-8 mb-3">   <input type="text" class="form-control form-control-user" id="emp1name" name="emp1name" aria-describedby="emailHelp" value="<?php  echo $row['Employer1Name'];?>"></div>
                    ...
                    <div class="row">
                      <div class="col-4 mb-3">Orphan1 Health Issues </div>
                    ...
                    <div class="row">
                    <div class="col-4 mb-3">0rphan1 Age </div>
                    ...
                    <div class="row">
                      <div class="col-4 mb-3">Orphan1 Weight</div>
                     <div class="col-8 mb-3">
                ...
                <div class="col-4 mb-3">Orphan2 Name</div>
                   <div class="col-8 mb-3">   <input type="text" class="form-control form-control-user" id="emp2name" name="emp2name" aria-describedby="emailHelp" value="<?php  echo $row['Employer2Name'];?>"></div>
                    ...
                    <div class="row">
                      <div class="col-4 mb-3">Orphan2 Health Issues </div>
                    ...
                    <div class="row">
                      <div class="col-4 mb-3">Orphan2 Weight</div>
                     <div class="col-8 mb-3">
                ...
                <div class="col-4 mb-3">Orphan3 Name</div>
                   <div class="col-8 mb-3">   <input type="text" class="form-control form-control-user" id="emp3name" name="emp3name" aria-describedby="emailHelp" value="<?php  echo $row['Employer3Name'];?>"></div>
                    ...
                    <div class="row">
                      <div class="col-4 mb-3">Orphan3 Health Issues </div>
                    ...
                    <div class="row">
                      <div class="col-4 mb-3">Orphan3 Weight</div>
                     <div class="col-8 mb-3">
...
<?php } else {?>
  ...
  <div class="row" style="margin-top:4%">
                      <div class="col-12" style="font-size:18px; color:red;">First Add your orphan details after that you can edit orphan details.</div>
