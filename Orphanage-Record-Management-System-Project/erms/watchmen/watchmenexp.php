...
if(isset($_POST['submit']))
  {
    ...
    $emp3wd=$_POST['emp3workduration'];
     ...
     $query=mysqli_query($con, "insert into watchmenexp ( EmpID,Employer1Name, Employer1Designation, Employer1CTC,  Employer1WorkDuration, Employer2Name,  Employer2Designation, Employer2CTC, Employer2WorkDuration, Employer3Name, Employer3Designation, Employer3CTC, Employer3WorkDuration) value('$eid','$emp1name', '$emp1des', '$emp1ctc', '$emp1wd', '$emp2name', '$emp2des', '$emp2ctc', '$emp2wd', '$emp3name', '$emp3des', '$emp3ctc', '$emp3wd' )");
    if ($query) {
...
<p style="font-size:16px; color:red" align="center"> <?php if($msg){
  ...
  <?php 
$empid=$_SESSION['uid'];
$query=mysqli_query($con,"select * from watchmenexp where EmpID=$empid");
