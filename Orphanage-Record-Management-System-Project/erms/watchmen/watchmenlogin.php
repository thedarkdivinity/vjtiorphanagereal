...
if(isset($_POST['login']))
  {
    ...
    $query=mysqli_query($con,"select ID from watchmen where  EmpEmail='$Email' && EmpPassword='$Password' ");
    $ret=mysqli_fetch_array($query);
    if($ret>0){
      $_SESSION['uid']=$ret['ID'];
     header('location:welcomewatchmen.php');
    }
    else{
      $msg="Invalid Details.";
    }
...
<head>
  ...
  <title>Orphanage Employee Login</title>
...
<body class="bg-gradient-primary">
  ...
  <div class="container">
    <h3 align="center" style="color: black; padding-top: 2%">Orphanage Record Managment System</h3>
    ...
    echo $msg;
                  ...
                  <hr>
                  <div class="text-center">
                    <a class="small" href="watchmenforgetpassword.php">Forgot Password?</a>
                  </div>
                  <div class="text-center">
                    <a class="small" href="watchmenregis.php">Create an Account!</a>
                  </div>
                </div>
              </div>
            </div>
