...
{
header('location:watchmenforgetpassword.php');
} else {
if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con,"update watchmen set EmpPassword='$password'  where  EmpEmail='$email' && EmpCode='$empid' ");
   if($query)
   {
