...
if(isset($_POST['submit']))
  {
    ...
    $Email=$_POST['Email'];
        ...
        $query=mysqli_query($con,"select ID from watchmen where  EmpEmail='$Email' and EmpCode='$empid' ");
    $ret=mysqli_fetch_array($query);
    if($ret>0){
      $_SESSION['empid']=$empid;
      $_SESSION['email']=$Email;
     header('location:watchmenresetpassword.php');
    }
    else{
...
<body class="bg-gradient-primary">
  ...
  <div class="container">
    <h3 align="center" style="color: black; padding-top: 2%">Orphanage Managment System</h3>
    ...
    echo $msg;
                  ...
                  <form class="user" method="post" action="">
                    ...
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" id="empid" name="empid" placeholder="Enter your UniqueID" required="true">
                    </div>
