...
if(isset($_POST['submit']))
  {
    ...
    $ret=mysqli_query($con, "select EmpEmail from watchmen where EmpEmail='$Email'");
    $result=mysqli_fetch_array($ret);
    if($result>0){
$msg="This email already associated with another account";
    }
    else{
    $query=mysqli_query($con, "insert into watchmen(EmpFname, EmpLName, EmpCode, EmpEmail,  EmpPassword) value('$FName', '$LName', '$empcode', '$Email', '$Password' )");
    if ($query) {
...
<head>
  ...
  <title>Orphanagd Managment System</title>
...
<body class="bg-gradient-primary">
  ...
  <div class="container">
    <h3 align="center" style="color: black; padding-top: 1%">Orphanage Managment System</h3>
    ...
    echo $msg;
              ...
              <form class="user" name="register" method="post" onsubmit="return checkpass();">
                <div class="form-group row">
                 ...
                 <div class="form-group">
                  <input type="text" class="form-control form-control-user" id="empcode" name="empcode" placeholder="Enter your UniqueID" pattern="[0-9]+" required="true">
                </div>
                <div class="form-group">
              ...
              <div class="text-center">
                <a class="small" href="watchmenlogin.php">Already have an account? Login!</a>
              </div>
            </div>
          </div>
        </div>
